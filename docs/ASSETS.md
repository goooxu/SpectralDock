...
| capsule-mascot.obj、model-manifest.json、四张运行时纹理和六张 gallery PNG | CC0-1.0 |
| third_party/tinyobjloader 下的 vendored 文件 | MIT |

CC0 只覆盖 assets/examples/models/CC0-1.0.txt 逐项列出的十二
个文件。tools/generate_mascot.py、tools/generate_benchmark_harbor.py、
...
docs/gallery 下六张 PNG 按 CC0-1.0 提供；同名 *.stats.json 是正式
