...
PhysX 封面生成器写出的 schema v6，体积积分仍完全由本章 CUDA 路径执行。
...
[上一章：PhysX 刚体模拟与场景 JIT 构建](10-physx-rigid-body-scene-baking.md) · [返回目录](README.md) · [下一章：运行时解析水面](12-runtime-analytic-water.md)
